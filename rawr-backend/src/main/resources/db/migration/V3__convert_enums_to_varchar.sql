...
ALTER TABLE articles ALTER COLUMN category TYPE VARCHAR(20) USING category::text;
ALTER TABLE articles ALTER COLUMN status TYPE VARCHAR(20) USING status::text;
